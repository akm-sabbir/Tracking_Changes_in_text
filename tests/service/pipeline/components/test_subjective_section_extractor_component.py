...
class TestSubjectiveSectionExtractorComponent(TestCase):
    ...
    def test__run_should_return_correct_response__given_large_text_input(self):
        ...
        "Status:\nContinence:\n\nHPI: s/p elective excisiion og bilateral suppurative hydradenitis, surgery was complicated by sepsis from\n" \
                                     ...
                                     "breathlessness and the surgial side is healing , but the rt side is leaking some, " \
                                     "clear liquid with no smell\nROS:\nConst: Denies chills, fever and sweats.\nEyes: " \
                                     "Denies a recent change in visual acuity and watery or itching eyes.\nENMT: Denies " \
                                     "congestion, excessive sneezing and postnasal drip.\nCV: Denies chest pain, orthopnea, " \
                                     "palpitations and swelling of ankles.\nResp: Denies cough, PND, SOB, sputum production " \
                                     "and wheezing.\nGI: Denies abdominal pain, constipation, diarrhea, hematemesis, melena, " \
