...
class TestTokenToGraphGenerationComponent(TestCase):
    ...
    def test__run__should_return_correct_response__given_correct_input(self, ):
        ...
        test_text_span_set_one_medication_secion = [TokenInfo(token="continues", start_of_span=25, end_of_span=34, offset=0),
        ...
        set_one_graph_generation_result = graph_generation_component.run({"text": test_text_set_one,
                       ...
                       TextTokenizationComponent: [test_text_span_set_one_subjective_secion,
        ...
        assert set_one_graph_generation_result[1].graph_token_container['he'][22].is_root == True
