...
class TestExclusionHandlingComponent(TestCase):
    ...
    def test__run__should_return_correct_response__given_correct_input(self, mock_boto3):
        from app.service.pipeline.components.icd10_exclusion_list_processing_component import \
        ...
        with patch.object(icd10_exclusion_list_processing, "icd10_exclusion_handling_service",
