...
class TestMedicationSectionExtractorComponent(TestCase):
    def test__run__should_return_correct_response__given_correct_input(self):
        ...
        assert subjective_section.medication_sections[0].relative_end == 11
        ...
        assert subjective_section.medication_sections[1].relative_start == 11
        assert subjective_section.medication_sections[1].relative_end == 21
    ...
    def test__run_should_return_correct_response__given_large_text_input(self):
        ...
        medication_section = extractor_component.run(annotation_results)[0]
        print(len(medication_section.medication_sections))
        for each in medication_section.medication_sections:
            print(str(each.start) + " " + str(each.end))
            print(str(each.relative_start) + " " + str(each.relative_end))
        print(medication_section.text)