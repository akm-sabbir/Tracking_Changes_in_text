...
class TestICD10SentimentExclusionServiceImpl(TestCase):
    @patch("app.service.impl.icd10_positive_sentiment_exclusion_service_impl.codecs.open", Mock())
    @patch("app.service.impl.icd10_positive_sentiment_exclusion_service_impl.os.path.join", Mock())
    ...
    def test_get_filtered_annotations_based_on_positive_sentiment__should_return_correct_response__given_correct_input(
        ...
        assert mock_filtered_icd10_list[0].medical_condition == "Tuberculosis"
